...
densidad={1:1.46,2:1.46,3:1.84,4:1.84,5:1.79,6:1.69,7:1.46,8:1.69,9:1.84,10:1.69}
...
def peso_triangulo(densidad,area):
    Peso=densidad*area
    return Peso
...
#crear la matriz areas, en donde se almacena la densidad en el indice 0 y el area en el indice 1
areas=[]
for j in range(4417):
    areas.append([0]*2)
contador=0
for g in range(4417):
    areas[g][0]=densidad[int (matriz_final[g][0])]
...
print(X0_TOTAL,Y0_TOTAL,Z0_TOTAL)